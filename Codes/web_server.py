...
# This code is used to use the motors and wheels functions.
# For our project, we have completed the remote_control() function.
# In this function, we save the speeds, the steering angles and the times for the dataset.
...
class Websocket():
    ...
    def remote_control(self, move):
        ...
        #####file = open('dataset/data1.txt', 'a')
        #####file.write(str(pow))
        #####file.write(",     ")
        #####file.write(str(dr_angle))
        #####file.write(",     ")
