# Authors: PiCar-X
# Authors for adding code: Julien Choukroun, Jessica Gourdon, Luc Sagnes

# This code is used to use the camera functions.
# For our project, we have completed the camera() function.
# In this function, we save the frames and the times for the dataset.
...
# 使用白色填充图片区域,默认为黑色
    ...
    def camera():
        ...
        # With the five #, this is what Julien, Jessica and Luc added to the code.
        ...
        while True:
            ...
            #####cpt = cpt + 1
            #####temps = str(time.time())
            #####cv2.imwrite("dataset/Images1/image_" + temps + ".jpg", img)
            #####file = open("dataset/time_images1.txt", "a")
            #####file.write("image_" + temps)
            #####file.write(",    ")
            #####file.write(temps)
            #####file.write("\n")
            #####file.flush()
